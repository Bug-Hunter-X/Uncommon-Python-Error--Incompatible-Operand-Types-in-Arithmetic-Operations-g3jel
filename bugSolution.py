...
result3 = function_with_improved_error_handling(10,"2") #Output: Error: Operands must be numbers, None
result4 = function_with_improved_error_handling("10",2) #Output: Error: Operands must be numbers, None